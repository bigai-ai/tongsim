from xuance.common import Callable, Optional, Sequence, Tuple, Union
from xuance.torch import Module, Tensor
from xuance.torch.utils import ModuleType, gru_block, lstm_block, mlp_block, nn, torch
