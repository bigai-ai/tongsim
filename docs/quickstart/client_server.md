...
- :material-account-group: **Multi-agent RL Navigation** — cooperative multi-agent task (MACSR) built on a lightweight adaptation of XuanCe, focusing on coordination under partial observability.
